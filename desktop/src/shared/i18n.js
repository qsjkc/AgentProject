...
const messages = {
  'zh-CN': {
    ...
    desktopIntro: '先配置服务地址，再登录云端账号，即可使用聊天、知识库和桌宠同步能力。',
    ...
    signIn: '登录',
    signingIn: '登录中...',
    desktopClientLoginSucceeded: '桌面客户端登录成功。',
    ...
    deleteFailed: '删除失败。',
    knowledgeHitHint: '已引用 {count} 条知识库内容。',
    knowledgeMissHint: '当前知识库未命中相关内容，本次回复主要基于通用对话。',
    signedOut: '已退出登录。',
    ...
    typeMessagePlaceholder: '输入想发给 {pet} 的内容...',
    sendMessage: '发送消息',
    sending: '发送中...',
    ...
    quickChatSetupText: '请先打开主面板，配置服务地址并登录账号后，再使用快捷聊天。',
    openMainPanel: '打开主面板',
    openMainPanelForMore: '去主面板看完整回复。',
    quickChatEmpty: '点一下 {pet}，然后在这里快速提问。桌宠会用简短气泡回复你。',
    quickChatPlaceholder: '输入一条简短消息给 {pet}...',
    send: '发送',
    dragWindowHint: '按住顶部即可拖动窗口',
    ...
    dragSaved: '桌宠位置已更新。',
    petShown: '桌宠已显示在桌面上。',
    petPositionReset: '桌宠已回到默认位置。',
    quickChatDisabledHint: '你已关闭单击打开快捷聊天。',
    interactionHint: '单击弹出快捷聊天，双击打开主面板，拖动可以移动桌宠。',
    petSelection: '桌宠形象',
  ...
  en: {
    ...
    desktopTitle: 'Detachym Desktop Client',
    desktopIntro: 'Set the server address first, then sign in to use chat, knowledge base tools, and desktop pet sync.',
    serverUrlPlaceholder: 'Server URL, for example https://detachym.top/api/v1',
    ...
    knowledgeHitHint: '{count} knowledge snippets were referenced.',
    knowledgeMissHint: 'No relevant knowledge base content was found for this reply.',
    ...
    openMainPanelForMore: 'Open the main panel for the full reply.',
    quickChatEmpty: 'Click {pet} and ask here. The pet will answer in a short floating bubble.',
    quickChatPlaceholder: 'Type a short message for {pet}...',
    send: 'Send',
    dragWindowHint: 'Drag the top bar to move the window',
    ...
    petShown: 'The desktop pet is visible again.',
    petPositionReset: 'The desktop pet was moved back to its default position.',
    quickChatDisabledHint: 'Single-click quick chat is disabled.',
    interactionHint: 'Single click opens quick chat, double click opens the main panel, drag to move the pet.',
    petSelection: 'Pet Persona',
    petSelectionHint: 'Click to switch the desktop pet. Bubble tone and quick chat mood update together.',
