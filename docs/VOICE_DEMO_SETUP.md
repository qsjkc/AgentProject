...
- `VOLC_VOICE_CHAT_ENABLE_RTS_SUBTITLE`
- `VOLC_VOICE_CHAT_SUBTITLE_MODE`
...
VOLC_VOICE_CHAT_TTS_CONFIG_JSON={}
VOLC_VOICE_CHAT_LLM_CONFIG_JSON={}
VOLC_VOICE_CHAT_ENABLE_RTS_SUBTITLE=true
VOLC_VOICE_CHAT_SUBTITLE_MODE=1
...
桌面端桌宠气泡字幕来自火山 AI 语音互动的 RTS 字幕消息，保持 `VOLC_VOICE_CHAT_ENABLE_RTS_SUBTITLE=true`，并使用 `VOLC_VOICE_CHAT_SUBTITLE_MODE=1` 同时下发用户和智能体字幕。
